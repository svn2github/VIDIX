/*
    Former driver for S3 Savage Series
    ...
    2004-11-09
      Initial version
    2007-12-30
      Initial version of S3 cards driver
      Trio64V/Virge support by Michael Kostylev
...
int VIDIX_NAME(vixConfigPlayback) (vidix_playback_t * vinfo)
{
  unsigned int i, bpp;
